var ColorHelper = (function () {
    ...
    ColorHelper.getColorsArray = function (p, total, baseColorArray) {
        ...
        var rainbowColors = baseColorArray.map(function (x) { return _this.getColorVector(x, p); });
        ;
...
var MarchingSquaresHelper = (function () {
    ...
    MarchingSquaresHelper.drawForCombination = function (p, x, y, bitmask) {
        var drawMesh = false;
        var drawLine = true;
        var midpoint = 0.5;
        ...
        if (bitmask == '0000') {
            ...
            if (drawLine)
                p.line(xZero, yMidpoint, xMidpoint, yZero);
            if (drawMesh) {
                p.beginShape();
                p.vertex(0, midpoint);
                p.vertex(midpoint, 0);
            ...
            if (drawLine)
                p.line(xPos - (PARAMS.gridSize / 2), yZero, xPos, yMidpoint);
            if (drawMesh) {
                p.beginShape();
            ...
            if (drawLine)
                p.line(xZero, yMidpoint, xPos, yMidpoint);
            if (drawMesh) {
                p.beginShape();
                p.vertex(0, midpoint);
                p.vertex(1, midpoint);
            ...
            if (drawLine)
                p.line(xPos - (PARAMS.gridSize / 2), yPos, xPos, yPos - (PARAMS.gridSize / 2));
            if (drawMesh) {
                p.beginShape();
            ...
            if (drawLine)
                p.line(xMidpoint, yZero, xMidpoint, yPos);
            if (drawMesh) {
                p.beginShape();
                p.vertex(midpoint, 0);
                p.vertex(midpoint, 1);
            ...
            if (drawLine)
                p.line(xZero, yPos - (PARAMS.gridSize / 2), xMidpoint, yPos);
            if (drawMesh) {
                p.beginShape();
            ...
            if (drawLine)
                p.line(xPos - (PARAMS.gridSize / 2), yZero, xPos - (PARAMS.gridSize / 2), yPos);
            if (drawMesh) {
                p.beginShape();
                p.vertex(1 - midpoint, 0);
                p.vertex(1 - midpoint, 1);
            ...
            if (drawLine)
                p.line(xZero, yPos - (PARAMS.gridSize / 2), xPos, yPos - (PARAMS.gridSize / 2));
            if (drawMesh) {
                p.beginShape();
                p.vertex(0, 1 - midpoint);
                p.vertex(1, 1 - midpoint);
            ...
            if (drawLine)
                p.line(xMidpoint, yZero, xPos, yMidpoint);
            if (drawMesh) {
                p.beginShape();
                p.vertex(midpoint, 0);
                p.vertex(1, midpoint);
            ...
            if (drawLine)
                p.line(xMidpoint, yZero, xZero, yMidpoint);
            if (drawMesh) {
                p.beginShape();
                p.vertex(midpoint, 0);
                p.vertex(0, midpoint);
    ...
    MarchingSquaresHelper.getCurrentPointArray = function (p, points) {
        var res = [];
    ...
    MarchingSquaresHelper.drawSquares = function (p, pointsArr) {
...
var Point = (function () {
    function Point(p, pointX, pointY, vx, vy, radius) {
        this.p = p;
        this.pointX = pointX;
        this.pointY = pointY;
        this.vx = vx;
